...
console.log(`\n🧪 Try it with curl:`);
console.log(`  # Public endpoint (no rate limit)`);
console.log(`  curl http://localhost:${port}/api/public`);
console.log(``);
console.log(`  # Rate limited endpoint (try multiple times)`);
console.log(`  for i in {1..6}; do curl -w "\\n" http://localhost:${port}/api/limited; done`);
console.log(``);
console.log(`  # Strict rate limit (2 req/min)`);
console.log(`  curl -X POST http://localhost:${port}/api/strict`);
console.log(``);
console.log(`  # View metrics`);
console.log(`  curl http://localhost:${port}/api/metrics-info`);
console.log(``);
