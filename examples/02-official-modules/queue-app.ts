...
console.log(`  curl -X POST http://localhost:${port}/api/notifications/send \\`);
console.log(`       -H "Content-Type: application/json" \\`);
console.log(`       -d '{"to":"test@example.com","subject":"Hello","body":"Hi there!"}'`);
console.log(``);
console.log(`  # Send batch notification`);
console.log(`  curl -X POST http://localhost:${port}/api/notifications/batch \\`);
console.log(`       -H "Content-Type: application/json" \\`);
console.log(`       -d '{"users":["a@example.com","b@example.com"],"message":"Batch message"}'`);
console.log(``);
console.log(`  # Check sent emails`);
console.log(`  curl http://localhost:${port}/api/notifications/sent`);
console.log(``);
console.log(`  # Get queue stats`);
console.log(`  curl http://localhost:${port}/api/queue/stats`);
