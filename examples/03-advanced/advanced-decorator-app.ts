...
console.log(`\n📝 Available endpoints:`);
console.log(`  GET  /api/products     - Get all products (cached, logged)`);
console.log(`  GET  /api/products/:id - Get product by ID (requires auth, cached, logged)`);
console.log(`  POST /api/products     - Create product (requires admin auth, logged)`);
console.log(`\n🧪 Try it with curl:`);
console.log(`  # 1. Get all products (check cache logs)`);
console.log(`  curl http://localhost:${port}/api/products`);
console.log(``);
console.log(`  # 2. Get product (will fail without auth)`);
console.log(`  curl http://localhost:${port}/api/products/1`);
console.log(``);
console.log(`  # 3. Get product with auth`);
console.log(`  curl http://localhost:${port}/api/products/1 \\`);
console.log(`       -H "Authorization: Bearer admin"`);
console.log(``);
console.log(`  # 4. Create product (requires admin)`);
console.log(`  curl -X POST http://localhost:${port}/api/products \\`);
console.log(`       -H "Authorization: Bearer admin" \\`);
console.log(`       -H "Content-Type: application/json" \\`);
console.log(`       -d '{"name":"New Product","price":300}'`);
